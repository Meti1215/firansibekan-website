...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-12 md:py-24 bg-[#F3F4F6]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xs md:text-xl text-gray-600 max-w-3xl mx-auto">
            Reach out to discuss health &amp; hospital solutions, IT consulting, electromechanical works, medical imaging systems, or partnership opportunities with Firansibekan Trade and Investment.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-14">
          ...
          >
                  ...
                  >
                    <CardContent className="p-3 md:p-6">
                      <div className="flex items-start space-x-2 md:space-x-4">
                        <div className="w-8 h-8 md:w-12 md:h-12 bg-[#0F2A4A] rounded-sm flex items-center justify-center flex-shrink-0 shadow-sm">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="h-48 md:h-80 bg-white rounded-sm overflow-hidden shadow-lg border border-[#E5E7EB]"
            >
              <iframe
            ...
            <Card className="border border-[#E5E7EB] shadow-md bg-white">
              <CardHeader>
                <CardTitle className="text-base md:text-2xl font-bold text-gray-900 flex items-center">
                  <FileText className="w-4 h-4 md:w-6 md:h-6 mr-2 md:mr-3 text-[#0F2A4A]" />
                  Contact Us
                </CardTitle>
              ...
              <CardContent className="p-4 md:p-6">
                <form onSubmit={handleSubmit} className="space-y-3 md:space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full bg-[#0F2A4A] hover:bg-[#0F2A4A] text-white shadow-xl shadow-[#0F2A4A]/20 transition-all duration-300"
                  >
                    {isSubmitting ? (
