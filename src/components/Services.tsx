...
const Services = () => {
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-b from-[#F3F4F6] to-white relative overflow-hidden">
      {/* Background Decoration */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-20 w-96 h-96 bg-[#0F2A4A]/20 rounded-sm blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-[#0F2A4A]/20 rounded-sm blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <span className="px-4 py-2 bg-[#0F2A4A] text-white rounded-sm text-sm font-semibold shadow-lg">
              What We Offer
            </span>
          </motion.div>
          <h2 className="text-4xl md:text-5xl font-bold font-heading mb-6">
            Our <span className="text-[#0F2A4A]">Services</span>
          </h2>
        ...
        >
          <div className="text-center mb-8">
            <Target className="w-12 h-12 text-[#0F2A4A] mx-auto mb-4" />
    ...
    >
      <Card className="h-full hover-lift group cursor-pointer border-0 shadow-lg overflow-hidden">
        <CardHeader className="text-center pb-4 relative">
          ...
          <CardTitle className="text-xl font-bold text-gray-900 group-hover:text-[#0F2A4A] transition-colors">
            {service.title}
          </CardTitle>
        ...
        <CardContent className="pt-0">
          ...
          <Button 
            variant="outline" 
            className="w-full group-hover:bg-[#0F2A4A] group-hover:text-white group-hover:border-[#0F2A4A] transition-all duration-300"
          >
            Learn More
