...
const Services = () => {
  ...
  const serviceColors = ['bg-[#0F2A4A]', 'bg-[#0F2A4A]', 'bg-[#0F2A4A]', 'bg-gray-900'] as const
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold font-heading mb-6">
            Our <span className="text-[#0F2A4A]">Core Ventures</span>
          </h2>
              ...
              >
                ...
                <div className={index % 2 === 0 ? '' : 'lg:col-start-2'}>
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-[#0F2A4A]/5 to-[#0F2A4A]/5 p-6 rounded-sm border border-[#0F2A4A]/10">
                      ...
                      <div className="grid md:grid-cols-2 gap-3">
                        {service.features.map((feature, idx) => (
                          <div key={idx} className="flex items-center gap-3">
                            <div className="w-2 h-2 bg-[#0F2A4A] rounded-sm flex-shrink-0" />
        ...
        >
          <div className="bg-white rounded-sm p-8 shadow-lg max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                className="px-8 py-3 bg-[#0F2A4A] text-white rounded-sm font-semibold hover:bg-[#0F2A4A] transition-colors"
                onClick={() => window.open(brand.phoneHref)}
              >
                Call: {brand.phone}
              </button>
              <button 
                className="px-8 py-3 border border-[#0F2A4A] text-[#0F2A4A] rounded-sm font-semibold hover:bg-[#0F2A4A]/10 transition-colors"
