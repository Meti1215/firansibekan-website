      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold font-heading mb-6">
            Our <span className="text-[#0F2A4A]">Medical Excellence</span>
          </h2>
            ...
            >
              ...
              >
                ...
                <CardContent className="p-3 md:p-4 lg:p-6">
                  <h3 className="text-sm md:text-base lg:text-lg font-bold text-gray-900 mb-1 md:mb-2 group-hover:text-[#0F2A4A] transition-colors line-clamp-2">
                    {sequence.title}
                  </h3>
                      ...
                      {selectedSequence.images.map((image, index) => (
                        <button
                          ...
                          className={`relative w-12 h-12 rounded-sm overflow-hidden flex-shrink-0 ${
                            index === currentImageIndex ? 'ring-2 ring-[#0F2A4A]' : ''
                          }`}
