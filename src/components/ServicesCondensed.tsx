...
const ServicesCondensed = () => {
  ...
  const featuredIds = ['health-hospitals', 'it-consulting', 'electromechanical', 'medical-imaging']
  ...
  const keyServices: Service[] = featuredDepartments.map((department, index) => ({
    ...
    icon: [Stethoscope, Terminal, Activity, Cpu][index],
    color: ['bg-[#0F2A4A]', 'bg-[#0F2A4A]', 'bg-[#0F2A4A]', 'bg-[#0F2A4A]'][index],
    media: ([
                ...
                <div className="mt-1.5 space-y-0.5">
                  {service.features.slice(0, 2).map((f, i) => (
                    <div key={i} className="flex items-center gap-1">
                      <div className="w-1 h-1 bg-[#0F2A4A] rounded-sm flex-shrink-0" />
                  ...
                  <div className="space-y-3 md:space-y-4 lg:space-y-6">
                    ...
                    <div className="bg-white p-3 md:p-4 lg:p-5 xl:p-6 rounded-sm md:rounded-sm border border-gray-100 shadow-sm">
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          <h4 className="text-sm md:text-base lg:text-lg xl:text-xl font-bold text-[#0F2A4A] mb-2 md:mb-3 lg:mb-4 flex items-center gap-2">
                          ...
                          <div className="grid grid-cols-1 gap-1.5 md:gap-2 lg:gap-3">
                            {service.features.map((feature, idx) => (
                              <div key={idx} className="flex items-center gap-2">
                                <div className="w-1 h-1 md:w-1.5 md:h-1.5 lg:w-2 lg:h-2 bg-[#0F2A4A] rounded-sm flex-shrink-0" />
                        ...
                        <div>
                          <h4 className="text-sm md:text-base lg:text-lg font-bold text-gray-900 mb-2 md:mb-3 lg:mb-4 flex items-center gap-2">
                            <CheckCircle className="w-3 h-3 md:w-4 md:h-4 lg:w-5 lg:h-5 text-[#0F2A4A]" />
                            Key Benefits:
                          </h4>
                          <div className="grid grid-cols-1 gap-1.5 md:gap-2 lg:gap-3">
        ...
        >
          <div className="bg-white border border-gray-100 rounded-sm md:rounded-sm p-4 md:p-8 shadow-lg max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                className="px-8 py-3 bg-[#0F2A4A] text-white rounded-sm font-semibold hover:bg-[#0F2A4A] transition-all duration-300 shadow-sm"
