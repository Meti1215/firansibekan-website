...
const BoneShowcase3D = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-white via-[#F3F4F6] to-[#0F2A4A]/5 relative overflow-hidden">
      {/* Background Decoration */}
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-10 right-10 w-72 h-72 bg-[#0F2A4A]/10 rounded-sm blur-3xl"></div>
        <div className="absolute bottom-10 left-10 w-96 h-96 bg-[#0F2A4A]/10 rounded-sm blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold font-heading mb-6">
            Orthopedic <span className="text-[#0F2A4A]">Anatomy</span>
          </h2>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <Info className="w-5 h-5 text-[#0F2A4A]" />
                  ...
                  <ul className="space-y-2">
                    {currentModel.details.map((detail, index) => (
                      ...
                      >
                        <div className="w-2 h-2 bg-[#0F2A4A] rounded-sm mt-2 flex-shrink-0"></div>
            ...
            {models.map((model, index) => (
              <motion.button
                ...
                className={`
                  ...
                  ${activeModel === index 
                    ? 'bg-gradient-to-r from-[#0F2A4A] to-[#0F2A4A] text-white shadow-[#0F2A4A]/50' 
                    : 'bg-white text-gray-700 hover:bg-gray-50 border-2 border-gray-200 hover:border-[#0F2A4A]/50'
                  }
                `}
              >
                {model.title}
