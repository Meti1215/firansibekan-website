...
const Team = () => {
  ...
  const founder: TeamMember = {
    ...
    bio: 'Our General Manager guides Firansibekan Trade and Investment across its core divisions in healthcare medical equipment, electromechanical works, IT consulting, and medical imaging installations.'
  }
  ...
  const stats = [
    { icon: Users, value: '2012', label: 'Establishment' },
    { icon: Globe, value: '4', label: 'Core Departments' },
    { icon: Building2, value: '1,102+', label: 'Platform Followers' },
    { icon: Award, value: '3+', label: 'Technical Specialists' },
  ]

  return (
    <section id="team" className="py-10 md:py-20 bg-[#F3F4F6]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xs md:text-xl text-gray-600 max-w-3xl mx-auto">
            Meet the leadership and technical specialists guiding Firansibekan Trade and Investment across its departments and engineering operations.
          </p>
        </motion.div>
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="text-center p-2.5 md:p-6 bg-white rounded-sm border border-[#E5E7EB] shadow-sm"
            >
              <div className="inline-flex items-center justify-center w-8 h-8 md:w-12 md:h-12 rounded-sm bg-[#0F2A4A] mb-1.5 md:mb-3 shadow-sm">
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <div className="bg-white rounded-sm border border-[#E5E7EB] shadow-md overflow-hidden">
            <div className="p-3 md:p-8 flex flex-row items-center gap-3 md:gap-10">
              ...
              <div className="text-left">
                <div className="inline-flex items-center gap-1.5 px-2 py-0.5 md:px-3 md:py-1 rounded-sm bg-[#0F2A4A]/15 text-[#0F2A4A] text-[9px] md:text-xs font-semibold mb-1 md:mb-3">
                ...
                <p className="text-[10px] md:text-base text-[#0F2A4A] font-semibold mb-1 md:mb-4">{founder.role}</p>
        ...
        <div className="space-y-4 md:space-y-8">
          {teamGroups.map((group) => (
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white rounded-sm border border-[#E5E7EB] shadow-md overflow-hidden"
            >
              <button
              ...
              >
                <div className="flex items-center gap-2 md:gap-4">
                  <div className="w-8 h-8 md:w-12 md:h-12 bg-[#0F2A4A] rounded-sm flex items-center justify-center">
                          ...
                          >
                            <div className="relative aspect-[3/4] rounded-sm md:rounded-sm overflow-hidden mb-2 md:mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                              {member.image ? (
                                ...
                                <div className="w-full h-full bg-gradient-to-br from-[#0F2A4A] to-[#0F2A4A] flex items-center justify-center">
                            ...
                            <p className="text-[8px] md:text-xs text-[#0F2A4A] font-medium mt-0.5">{member.role}</p>
                            <AnimatePresence>
