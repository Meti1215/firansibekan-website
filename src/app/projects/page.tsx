  ...
  const projects: ProjectCard[] = [
    {
      ...
      href: '/projects/okote/',
      image: '/assets/hero/hero-placeholder-6.jpg',
      icon: Gem,
    },
    {
      ...
      image: '/assets/hero/hero-placeholder-7.jpg',
      icon: Mountain,
    },
  ]
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-5 font-heading">
              Our <span className="text-[#0F2A4A]">Projects</span>
            </h1>
              ...
              <div className="relative aspect-[16/10] overflow-hidden bg-gray-200">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-white/15 text-white text-sm font-semibold backdrop-blur">
                    <p.icon className="w-4 h-4 text-[#0F2A4A]" />
                    {p.subtitle}
                  </div>
