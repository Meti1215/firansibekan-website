...
import { ArrowRight, Briefcase, Globe, Users, Heart } from 'lucide-react'
...
export default function EventsPage() {
  const icons = [Globe, Heart, Briefcase, Users]
  const images = [
    ...
    <main className="relative min-h-screen bg-gray-50">
      ...
      <section className="pt-navbar pb-8 md:pb-14 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-sm bg-[#0F2A4A]/10 text-[#0F2A4A] text-sm font-semibold mb-6">
      ...
      <section className="pb-10 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-4 md:space-y-10">
          ...
          <div className="rounded-sm md:rounded-sm bg-gradient-to-r from-[#0F2A4A] to-[#0F2A4A] text-white p-4 md:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-6">
            <div>
              ...
              <p className="text-[10px] md:text-base text-white/80 mt-1 md:mt-2 leading-relaxed max-w-2xl">
                Browse photos from our installations, diagnostic system calibrations, and site engineering operations across the Firansibekan portfolio.
              </p>
            </div>
            <Button
              variant="outline"
