        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-sm focus:ring-2 focus:ring-[#0F2A4A] focus:border-transparent outline-none transition-all"
          ...
          <div>
            ...
            <div className="bg-white rounded-sm border border-gray-300 overflow-hidden">
              <textarea
                ...
                rows={12}
                className="w-full min-h-[300px] px-4 py-3 border border-gray-300 rounded-sm focus:ring-2 focus:ring-[#0F2A4A] focus:border-transparent outline-none transition-all"
              />
            </div>
          </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 pb-8 border-b border-gray-200">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setTitle(e.target.value)}
            required
            className="w-full px-4 py-2 border border-gray-300 rounded-sm focus:ring-2 focus:ring-[#0F2A4A] focus:border-transparent outline-none"
    ...
    <div className="space-y-8">
      <form onSubmit={handleSubmit} className="space-y-6 pb-8 border-b border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
            <BookOpen className="w-5 h-5 text-[#0F2A4A]" />
          ...
          <div>
            ...
            {pdfFile && (
              <div className="mt-3 flex items-center gap-2 text-sm text-gray-600 bg-gray-50 px-3 py-2 rounded-sm">
                <FileText className="w-4 h-4 text-[#0F2A4A]" />
        ...
        {reports.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {reports.map((report) => (
              ...
              >
                <div className="aspect-[3/4] relative bg-gradient-to-br from-[#0F2A4A]/10 to-[#0F2A4A]/5">
                  {report.cover_image_url ? (
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-[#0F2A4A]/40">
                      <BookOpen className="w-16 h-16 mb-2" />
                      <span className="text-4xl font-bold">{report.year}</span>
                    </div>
                  )}
                  <div className="absolute top-2 right-2 bg-[#0F2A4A] text-white text-xs font-bold px-2 py-1 rounded-sm">
                    {report.year}
                  </div>
                </div>
                <div className="p-4">
