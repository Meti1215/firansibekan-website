              ...
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="relative lg:w-1/2 aspect-[16/9] lg:aspect-auto overflow-hidden bg-gray-200">
                  {featuredArticle.image_url ? (
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-[#0F2A4A]/10 via-gray-100 to-gray-200 flex items-center justify-center">
                      <Newspaper className="w-20 h-20 text-gray-300" />
                    </div>
                  )}
                  <div className="absolute top-4 left-4">
                    <span className="inline-flex items-center px-3 py-1.5 text-xs font-bold text-white bg-[#0F2A4A] rounded-sm shadow-lg">
                      Featured Article
                    </span>
                  </div>
                </div>
                ...
                <div className="lg:w-1/2 p-4 md:p-8 lg:p-10 xl:p-12 flex flex-col justify-center">
                  <span className="inline-flex items-center px-3 py-1 mb-4 text-xs font-semibold text-[#0F2A4A] bg-[#0F2A4A]/10 rounded-sm w-fit">
                    {featuredArticle.category}
                  </span>
                  <h2 className="text-base md:text-2xl lg:text-3xl font-bold text-gray-900 mb-2 md:mb-4 leading-snug group-hover:text-[#0F2A4A] transition-colors">
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between p-1.5 md:p-3 rounded-sm transition-colors text-left group ${
                          selected ? 'bg-[#0F2A4A]/10 border border-[#0F2A4A]/20' : 'hover:bg-gray-50'
                        }`}
                      >
                        <div className="flex items-center space-x-1.5 md:space-x-3">
                          <IconComponent className={`w-3.5 h-3.5 md:w-5 md:h-5 ${selected ? 'text-[#0F2A4A]' : 'text-[#0F2A4A]'}`} />
                          <span className={`text-[10px] md:text-base transition-colors ${selected ? 'text-[#0F2A4A] font-semibold' : 'text-gray-700 group-hover:text-[#0F2A4A]'}`}>
                            {category.name}
                          </span>
                        </div>
                        ...
                        >
                          ...
                          <div className="relative aspect-[3/4] rounded-sm overflow-hidden shadow-lg group-hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-2 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
                            {report.cover_image_url ? (
                              ...
                              <div className="absolute inset-0 flex flex-col items-center justify-center p-6 bg-gradient-to-br from-[#0F2A4A]/90 via-[#0F2A4A]/80 to-[#E63946]">
                            ...
                            {/* Year badge */}
                            <div className="absolute top-3 right-3 bg-[#0F2A4A] text-white text-xs font-bold px-2.5 py-1 rounded-sm shadow-lg">
                              {report.year}
                            </div>
                            ...
                            {/* Hover overlay */}
                            <div className="absolute inset-0 bg-[#0F2A4A]/0 group-hover:bg-[#0F2A4A]/10 transition-colors duration-300 flex items-center justify-center">
                              <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-white/95 backdrop-blur-sm rounded-sm px-5 py-2.5 shadow-xl flex items-center gap-2">
                                <BookOpen className="w-4 h-4 text-[#0F2A4A]" />
                          ...
                          <div className="mt-4 px-1">
                            <h3 className="font-bold text-gray-900 text-sm md:text-base leading-tight group-hover:text-[#0F2A4A] transition-colors line-clamp-2">
                              {report.title}
                            </h3>
                            {report.description && (
                            ...
                            <div className="flex items-center gap-3 mt-3">
                              ...
                              <a
                                ...
                                className="text-xs text-[#0F2A4A] hover:underline flex items-center gap-1"
                              >
                      ...
                      >
                        ...
                        <div className="relative w-full aspect-video overflow-hidden bg-gray-200">
                          ...
                          <div className="absolute top-3 left-3">
                            <span className="inline-flex items-center px-2.5 py-1 text-[11px] font-bold text-white bg-[#0F2A4A] rounded-sm shadow-md">
                              {article.category}
                            </span>
                          </div>
                        ...
                        <div className="p-2.5 md:p-5 flex flex-col justify-between flex-1">
                          <div>
                            <h3 className="text-[11px] md:text-lg font-bold text-gray-900 mb-1 md:mb-2 leading-tight md:leading-snug group-hover:text-[#0F2A4A] transition-colors line-clamp-2">
                              {article.title}
                            </h3>
                          ...
                          <div className="flex items-center justify-between pt-4 mt-4 border-t border-gray-100">
                            <div className="flex items-center space-x-2 text-xs text-gray-500">
                              <div className="w-6 h-6 rounded-sm bg-[#0F2A4A]/10 flex items-center justify-center">
                                <User className="w-3 h-3 text-[#0F2A4A]" />
                              </div>
                              <span className="truncate max-w-[140px]">{article.author}</span>
                            </div>
                            <span className="text-xs font-semibold text-[#0F2A4A] flex items-center gap-1 group-hover:gap-2 transition-all">
                              Read More
